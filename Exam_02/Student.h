...
class Student
{
    ...
    public:
        Student();
        Student(const MyString &, const MyString &, const MyString &, const StudentDate &, const StudentPhone &, const TestScore<double> &);
        Student(const Student &);
        ~Student();

        void setValues(const MyString &, const MyString &, const MyString &, const StudentDate &, const StudentPhone &, const TestScore<double> &);
